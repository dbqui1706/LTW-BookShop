                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="lh-lg">
                                            <b>Người nhận</b>: <c:out value="${sessionScope.currentUser.fullName}"
                                                                      default="..."/> <br>
                                            <b>Số điện thoại</b>: <c:out value="${sessionScope.currentUser.phoneNumber}"
                                                                         default="..."/> <br>
                                            <b>Địa chỉ</b>: <c:out value="${sessionScope.currentUser.address}"
                                                                   default="..."/>
                                        </p>
                                    </div>
                                    <div class="col-lg-4">
